...
public class MeepMeepTesting {
    ...
    public static void main(String[] args) {
        ...
        myBot.runAction(myBot.getDrive().actionBuilder(new Pose2d(0, 63, Math.toRadians(90)))
                .setTangent(-PI/2)
                .lineToY(38) //fwd to bar
                //hang specimen #1
                .lineToY(50) //pull out from bar a bit
                .splineToConstantHeading(new Vector2d(-35,25), -PI/2) //to blue sample
                .splineToConstantHeading(new Vector2d(-38, 10), -PI/2) //to blue sample
                .splineToConstantHeading(new Vector2d(-40, 42), -PI/2) //to human player zone
                .splineToConstantHeading(new Vector2d(-44, 10), -PI/2) //to blue sample #2
                .splineToConstantHeading(new Vector2d(-49, 12), -PI/2) //to blue sample #2
                .splineToConstantHeading(new Vector2d(-52, 42), -PI/2) //to human player zone
                ...
                //.splineToConstantHeading(new Vector2d(-53, 10), -PI/2) //to blue sample #3
              //  .splineToConstantHeading(new Vector2d(-39, 56), PI/4) // to wall - to pick up specimen
                //grab specimen #3
                //.lineToY(45) // pull out from wall a bit
               // .splineToConstantHeading(new Vector2d(0, 40), -PI/2) //to submersible
                ...
                //grab specimen #5
                .splineToConstantHeading(new Vector2d(0, 40), -PI/2)
